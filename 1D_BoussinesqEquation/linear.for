C	NUMERICAL SCHEME TO SOLVE THE NON-DIMENSIONAL BOUSSINESQ EQUATION (1-D)
C	USING INFINITE ELEMENTS	IN THE FINITE ELEMENT ANALYSIS
C
C	**********************************************************************
C	This code simulates the stream seepage to an infinite phreatic aquifer
C	by implementing the infinite elements in the finite element analysis. 
C	The code has been developed by Ch. Doulgeris (chdoulgeris@gmail.com)
C	and is freely available for downloading and further modification
C	at www.lri.swri.gr and https://github.com/chdoulgeris/InfElem.
C	**********************************************************************
C	
...
C
 ...
 202	FORMAT('OUTPUT FILE - RESULTS - linf1rc.out'//
     $'SOLVING THE LINEARISED(ÙÓ ÐÑÏÓ Ç**2)'/
     $'AND NON-DIMENSIONAL EQUATION OF BOUSSINESQ'/
     $'AS WELL AS THE EQUATION OF CONTAMINANT TRANSPORT'/
     $'USING THE FINITE ELEMENT METHOD'//
     $'APPROACHES AT THE EDGE OF THE SIMULATION AREA'/
 ...
 203	FORMAT('OUTPUT FILE - RESULTS - lineard.out'//
     ...
     $4X,'I',4X,'Æ1(I×)',4X,'Æ2(I×)',4X,'Æ3(I×)',5X,'a4-Z2',6X,'a4-Z3')	
